...
public class LuaLoader implements JavaFunction, CoronaRuntimeListener {
	...
	private static final String EVENT_NAME = "pluginBugSnagEvent";
	...
	public int init(LuaState L) {
		...
		if (L.isTable(-1)) {
			...
			L.pop(1);
				...
				Log.e("Solar2d-ironSourceSDK", "^^^^^Not a table");
		}


		CoronaActivity activity = CoronaEnvironment.getCoronaActivity();

		Configuration config = Configuration.load(activity);
		if (userId != null && email != null && name != null) {
			config.setUser(userId, email, name);
		}

		Bugsnag.start(activity, config);
		return 0;
	}

	public int crash(LuaState L) {

		Bugsnag.notify(new RuntimeException("Test error"));
		return 0;
	}

	public int leaveBreadcrumb(LuaState L) {

		String breadcrumb = L.checkString( 1 );
		if ( null != breadcrumb ) {
	...
	@SuppressWarnings("unused")
	private class LeaveBreadcrumbWrapper implements NamedJavaFunction {
		/**
	...
	@SuppressWarnings("unused")
	private class CrashWrapper implements NamedJavaFunction {
		/**
		 * Gets the name of the Lua function as it would appear in the Lua script.
		 * @return Returns the name of the custom Lua function.
		 */
